              ...
              <div class="row ">
                ...
                <div class="col-12">
                  <ol class="breadcrumb breadcrumb-right-arrow">
                    <li class="breadcrumb-item" ><a style="color: grey" href="<?php echo base_url(); ?>Category">Category</a></li>
                    <li class="breadcrumb-item active"><span style="color: black">Detail Category</span></li>
                  </ol>
                </div>
              </div>
            </div>
                ...
                <div class="col-md-12">
                  <div class="row mb-5">
                    ...
                    <div class="col-12 text-right">
                      <a href="" class="btn text-white btn-secondary" data-toggle="modal" data-target="#modal_add"><i class="fa fa-plus"></i>
                      Add Image</a>
                    </div>
                  </div>
                </div>
